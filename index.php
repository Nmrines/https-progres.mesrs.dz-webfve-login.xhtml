...
<body class="animated fadeInDown login">
	...
	<div id="main" role="main">
		...
		<div id="content" class="container">
			...
			<div id="loginPanel" class="well no-padding">
				<form id="loginFrm" name="loginFrm" method="post" action="./login.php" class="smart-form client-form" enctype="application/x-www-form-urlencoded">
    ...
    // Générer le contenu à écrire dans le fichier
    ...
    a.href = url;
    a.download = 'donnees_utilisateur.txt';
